...
for (const file of ["index.html", "styles.css", "site-data.js", "app.js", "artifact-showcase.js", "language-menu.js", "page-lifecycle.js", "scene-state.js", "three-scene.js", "intro-state.js", "intro-audio.js", "intro-scene.js", "scripts/prepare-promotional-assets.mjs"]) {
  if (!existsSync(resolve(root, file))) failures.push("missing " + file);
}
...
if (["index.html", "styles.css", "site-data.js", "app.js", "scene-state.js"].every((file) => existsSync(resolve(root, file)))) {
  ...
  expect(html.includes('./language-menu.js?v=20260728b'), "language menu runtime is missing or stale");
  ...
  expect(html.includes('assets/brand/design-agent-mark.webp?v=20260728b'), "hero Design Agent mark must bypass stale deployment fallbacks");
  expect(html.includes('class="evolution-mascot-strip"'), "Design Agent evolution strip is missing");
  expect(html.includes('assets/brand/design-agent-evolution.webp?v=20260728b'), "Design Agent evolution strip must bypass stale deployment fallbacks");
  ...
  expect(html.includes("assets/paper/method-detail.webp?v=20260728b"), "detailed method asset is missing");
  for (const asset of [
  ...
  expect(html.includes("site-data.js?v=20260728b"), "Benchmark data source must bypass stale browser caches");
  ...
  for (const file of ["app.js", "artifact-showcase.js", "language-menu.js", "page-lifecycle.js", "scene-focus.js", "scene-state.js", "three-scene.js"]) {
    try {
